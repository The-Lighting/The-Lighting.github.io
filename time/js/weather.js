let cityName = "Konnagar, IN"; // your city name
let units = "metric"; //metric or imperial
let weatherApi = "b3c262d7d2bc497f58efa460eb91d5e9"; //your open weather api key here. uses current weather and 5 day 3 hour forecast
...
function livelyPropertyListener(name, val)
{
  switch(name) {
	  ...
	  else
	  {
  	  ...
  	  break;
	case "cityInput":
	  cityName = "Konnagar, IN";
	  break;    
	case "apiInput":
	  weatherApi = "b3c262d7d2bc497f58efa460eb91d5e9";
	  break;
	case "unit":
	  	units = "metric"; 
